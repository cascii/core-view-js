...
__export(index_exports, {
  ...
  Frame: () => Frame,
  FrameCanvasCache: () => FrameCanvasCache,
  FrameColors: () => FrameColors,
  FrameFile: () => FrameFile,
  FrameLoaderState: () => FrameLoaderState,
  ...
  detailsFrameColors: () => detailsFrameColors,
  drawCachedCanvas: () => drawCachedCanvas,
  drawFrameFromCache: () => drawFrameFromCache,
  loadColorFrames: () => loadColorFrames,
  loadFramesFromUrls: () => loadFramesFromUrls,
  loadTextFrames: () => loadTextFrames,
  parseCframe: () => parseCframe,
  parseCframeText: () => parseCframeText,
  parseColor: () => parseColor,
  parseDetailsToml: () => parseDetailsToml,
  renderCframe: () => renderCframe,
  renderTextToCanvas: () => renderTextToCanvas,
  renderToCanvas: () => renderToCanvas,
  renderToOffscreenCanvas: () => renderToOffscreenCanvas,
  textBatchColorString: () => textBatchColorString,
